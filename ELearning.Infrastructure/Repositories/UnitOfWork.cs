namespace ELearning.Infrastructure.Repositories
{
    public class UnitOfWork : IUnitOfWrok
    {
        ...
        public UnitOfWork(AppDbContext context, IWebHostEnvironment environment, UserManager<ApplicationUser> userManager, RoleManager<IdentityRole> roleManager, IOptions<JWT> jwt, IMailRepository mail)
        {
            _context = context;
            ...
            Auths = new AuthRepository(_userManager, _roleManager, _jwt, _mail);
        }
